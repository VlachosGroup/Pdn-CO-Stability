...
def save_POV(Pdi, index, atoms,output_dir):
    ...
    pov_args = {
        ...
        'rotation': '0x, 0y, 30z', #Position of camera. If you want different angles, the format is 'ax, by, cz' where a, b, and c are angles in degrees
...
#save_POV(10, 4, atoms, POV_dir)

    
# for file_i in files:
#     Pdi = file_i.split('-')[0].replace('Pd','')
#     index = file_i.split('-')[1]
#     save_POV(Pdi, index, read(file_i), POV_dir)
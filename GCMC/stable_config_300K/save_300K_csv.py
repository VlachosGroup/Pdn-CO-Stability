...
#%%
# plot volin for the each isomer
x1 = 9
df_x1 = df_TP.loc[(df_TP['n'] == x1)]
iso_indices = list(np.arange(0, np.max(df_x1['iso_index'])+1))
iso_labels = ['i' + str(i) for i in iso_indices]
mu_iso_list = []
mco_iso_list = []

for i in iso_indices:
    sub_df = df_x1.loc[df_x1['iso_index']== i]
